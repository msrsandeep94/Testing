...
public class Test46_Hashmap     //Gmail password via DDT using hashmap
{
	public static void main(String[] args) 
	{
		...
		for(Map.Entry<String, String> e :pwds.entrySet())
		{
			try
			{
				...
				else if(e.getValue().equalsIgnoreCase("invalid") && driver.findElement(By.xpath("//*[contains(text(),'Wrong password')]")).isDisplayed())
				{
					et.log(LogStatus.PASS, "invalid pwd test passed");
				}
				else if(e.getValue().equalsIgnoreCase("valid") && driver.findElement(By.xpath("//*[text()='Compose']")).isDisplayed())
				{
